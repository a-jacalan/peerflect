...
require_once "check-banned.php";;
    ...
    $sql = "SELECT Posts.PostID, Posts.isApproved, Posts.Title, Posts.CreatedAt, Users.ProfileImageURL 
            ...
            WHERE Posts.SubCategory = 'Secure Shell (SSH) and Secure Sockets Layer (SSL)
' 
...
<head>
    ...
    <title>Secure Shell (SSH) and Secure Sockets Layer (SSL) Posts</title>
...
<body class="topics-bg">
    ...
    <div class="topics-container">
        <h2>Secure Shell (SSH) and Secure Sockets Layer (SSL) Posts</h2>
        <?php if (empty($posts)): ?>
