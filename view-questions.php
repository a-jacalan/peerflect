...
<body class="topics-bg">
    ...
    <div class="topics-container">
        ...
        <div class="contributor-container">
            ...
            <div class="right-container" onclick="revealAnswer()">
                <div id="reveal-text">Click to Reveal Answer</div>
                <?php if(count($questions) > 0): ?>
                    <div class="answer" style="display: none;">
                        <?php echo htmlspecialchars($questions[0]['AnswerContent']); ?>
                    </div>
                    <button id="hide-button" style="display: none;" onclick="hideAnswer(event)">Hide Answer</button>
                <?php else: ?>
                    <p>No questions found for this post.</p>
                <?php endif; ?>
            </div>
    ...
    <script>
        ...
        function revealAnswer() {
            ...
            if (answer.style.display === "none") {
                ...
                rightContainer.classList.add("revealed");
            }
        }

        function hideAnswer(event) {
            event.stopPropagation(); // Prevent the click from triggering revealAnswer
            var rightContainer = document.querySelector(".right-container");
            var answer = document.querySelector(".answer");
            var revealText = document.getElementById("reveal-text");
            var hideButton = document.getElementById("hide-button");
            ...
            rightContainer.classList.remove("revealed");
        }
