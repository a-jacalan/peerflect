...
require_once "check-banned.php";;
    ...
    $sql = "SELECT Posts.PostID, Posts.isApproved, Posts.Title, Posts.CreatedAt, Users.ProfileImageURL 
            ...
            WHERE Posts.SubCategory = 'WAN Technologies' 
...
<head>
    ...
    <title>WAN Technologies Posts</title>
        ...
        <div class="menu">
            ...
            <div class="menu-loginreg">
                <?php if(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true) { ?>
                    ...
                    <?php } else { ?>
                        <div class="dropdown">
                            <a href="#" class="active account-link"><?php echo htmlspecialchars($fullname); ?></a>
