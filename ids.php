...
require_once "check-banned.php";;
    ...
    $sql = "SELECT Posts.PostID, Posts.isApproved, Posts.Title, Posts.CreatedAt, Users.ProfileImageURL 
            ...
            WHERE Posts.SubCategory = 'Firewalls and Intrusion Detection Systems (IDS)' 
...
<head>
    ...
    <title>Firewalls and Intrusion Detection Systems (IDS) Posts</title>
...
<body class="topics-bg">
    ...
    <div class="topics-container">
        <h2>Firewalls and Intrusion Detection Systems (IDS) Posts</h2>
        <?php if (empty($posts)): ?>
